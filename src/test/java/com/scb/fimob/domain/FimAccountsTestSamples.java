...
public class FimAccountsTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));

    public static FimAccounts getFimAccountsSample1() {
        return new FimAccounts()
            .id(1L)
    ...
    public static FimAccounts getFimAccountsSample2() {
        return new FimAccounts()
            .id(2L)
    ...
    public static FimAccounts getFimAccountsRandomSampleGenerator() {
        return new FimAccounts()
