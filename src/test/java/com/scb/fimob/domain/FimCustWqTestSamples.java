...
public class FimCustWqTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));

    public static FimCustWq getFimCustWqSample1() {
        return new FimCustWq()
            .id(1L)
            .custId("custId1")
            .clientId("clientId1")
            .idType("idType1")
    ...
    public static FimCustWq getFimCustWqSample2() {
        return new FimCustWq()
            .id(2L)
            .custId("custId2")
            .clientId("clientId2")
    ...
    public static FimCustWq getFimCustWqRandomSampleGenerator() {
        return new FimCustWq()
