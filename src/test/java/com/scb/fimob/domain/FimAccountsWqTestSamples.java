...
public class FimAccountsWqTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));

    public static FimAccountsWq getFimAccountsWqSample1() {
        return new FimAccountsWq()
            .id(1L)
    ...
    public static FimAccountsWq getFimAccountsWqSample2() {
        return new FimAccountsWq()
            .id(2L)
    ...
    public static FimAccountsWq getFimAccountsWqRandomSampleGenerator() {
        return new FimAccountsWq()
