...
public class FimAccountsAsserts {
     ...
     */
    public static void assertFimAccountsAllPropertiesEquals(FimAccounts expected, FimAccounts actual) {
        assertFimAccountsAutoGeneratedPropertiesEquals(expected, actual);
        assertFimAccountsAllUpdatablePropertiesEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertFimAccountsAllUpdatablePropertiesEquals(FimAccounts expected, FimAccounts actual) {
        assertFimAccountsUpdatableFieldsEquals(expected, actual);
        assertFimAccountsUpdatableRelationshipsEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertFimAccountsAutoGeneratedPropertiesEquals(FimAccounts expected, FimAccounts actual) {
        assertThat(expected)
            .as("Verify FimAccounts auto generated properties")
     ...
     * @param actual the actual entity
     */
    public static void assertFimAccountsUpdatableFieldsEquals(FimAccounts expected, FimAccounts actual) {
        assertThat(expected)
            .as("Verify FimAccounts relevant properties")
     ...
     * @param actual the actual entity
     */
    public static void assertFimAccountsUpdatableRelationshipsEquals(FimAccounts expected, FimAccounts actual) {}
}
