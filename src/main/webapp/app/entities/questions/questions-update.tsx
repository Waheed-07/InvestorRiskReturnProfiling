  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="myApp.questions.home.createOrEditLabel" data-cy="QuestionsCreateUpdateHeading">
            <Translate contentKey="myApp.questions.home.createOrEditLabel">Create or edit a Questions</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('myApp.questions.questionText')}
                id="questions-questionText"
                name="questionText"
              ...
              />
              <ValidatedField
                label={translate('myApp.questions.questionType')}
              ...
              />
              <ValidatedField
                label={translate('myApp.questions.createdAt')}
