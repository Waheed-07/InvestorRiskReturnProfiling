...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './options.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPTIONS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OPTIONS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OPTIONS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OPTIONS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OPTIONS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OPTIONS actions', async () => {
      const arg = 42666;
