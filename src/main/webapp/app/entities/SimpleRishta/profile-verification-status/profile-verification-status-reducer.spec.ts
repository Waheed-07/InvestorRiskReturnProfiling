...
import reducer, {
  ...
  reset,
  updateEntity,
} from './profile-verification-status.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROFILEVERIFICATIONSTATUS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROFILEVERIFICATIONSTATUS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROFILEVERIFICATIONSTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PROFILEVERIFICATIONSTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PROFILEVERIFICATIONSTATUS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROFILEVERIFICATIONSTATUS actions', async () => {
      const arg = 42666;
