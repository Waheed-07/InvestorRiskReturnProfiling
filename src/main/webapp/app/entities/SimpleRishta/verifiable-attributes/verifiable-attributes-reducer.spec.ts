...
import reducer, {
  ...
  reset,
  updateEntity,
} from './verifiable-attributes.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERIFIABLEATTRIBUTES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERIFIABLEATTRIBUTES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERIFIABLEATTRIBUTES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERIFIABLEATTRIBUTES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERIFIABLEATTRIBUTES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERIFIABLEATTRIBUTES actions', async () => {
      const arg = 42666;
