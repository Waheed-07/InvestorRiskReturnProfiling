...
import reducer, {
  ...
  reset,
  updateEntity,
} from './user-verification-attributes.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERVERIFICATIONATTRIBUTES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERVERIFICATIONATTRIBUTES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERVERIFICATIONATTRIBUTES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_USERVERIFICATIONATTRIBUTES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_USERVERIFICATIONATTRIBUTES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERVERIFICATIONATTRIBUTES actions', async () => {
      const arg = 42666;
