...
import reducer, {
  ...
  reset,
  updateEntity,
} from './application-configurations.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPLICATIONCONFIGURATIONS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APPLICATIONCONFIGURATIONS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APPLICATIONCONFIGURATIONS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_APPLICATIONCONFIGURATIONS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_APPLICATIONCONFIGURATIONS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_APPLICATIONCONFIGURATIONS actions', async () => {
      const arg = 42666;
