...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERSONALDETAILS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PERSONALDETAILS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PERSONALDETAILS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PERSONALDETAILS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PERSONALDETAILS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PERSONALDETAILS actions', async () => {
      const arg = 42666;
