...
export const PersonalDetailsDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(personalDetailsEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="myApp.personalDetails.delete.question">
        <Translate contentKey="myApp.personalDetails.delete.question" interpolate={{ id: personalDetailsEntity.id }}>
...
export default PersonalDetailsDeleteDialog;
