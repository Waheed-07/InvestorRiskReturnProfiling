...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIMACCOUNTSWQ_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FIMACCOUNTSWQ actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FIMACCOUNTSWQ actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FIMACCOUNTSWQ actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FIMACCOUNTSWQ actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FIMACCOUNTSWQ actions', async () => {
      const arg = 42666;
