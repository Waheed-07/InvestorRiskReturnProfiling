...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIMSETTACCT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FIMSETTACCT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FIMSETTACCT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FIMSETTACCT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FIMSETTACCT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FIMSETTACCT actions', async () => {
      const arg = 42666;
