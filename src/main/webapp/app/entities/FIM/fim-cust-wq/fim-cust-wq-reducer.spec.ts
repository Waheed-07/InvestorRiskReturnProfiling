...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIMCUSTWQ_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FIMCUSTWQ actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FIMCUSTWQ actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FIMCUSTWQ actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FIMCUSTWQ actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FIMCUSTWQ actions', async () => {
      const arg = 42666;
