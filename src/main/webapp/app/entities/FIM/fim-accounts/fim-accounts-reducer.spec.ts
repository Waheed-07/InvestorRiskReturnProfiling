...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIMACCOUNTS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FIMACCOUNTS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FIMACCOUNTS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FIMACCOUNTS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FIMACCOUNTS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FIMACCOUNTS actions', async () => {
      const arg = 42666;
