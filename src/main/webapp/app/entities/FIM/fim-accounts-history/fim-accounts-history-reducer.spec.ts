...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './fim-accounts-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIMACCOUNTSHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FIMACCOUNTSHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FIMACCOUNTSHISTORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FIMACCOUNTSHISTORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FIMACCOUNTSHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FIMACCOUNTSHISTORY actions', async () => {
      const arg = 42666;
