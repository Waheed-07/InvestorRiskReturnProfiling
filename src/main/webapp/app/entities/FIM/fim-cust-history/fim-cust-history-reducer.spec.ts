...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIMCUSTHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FIMCUSTHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FIMCUSTHISTORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FIMCUSTHISTORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FIMCUSTHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FIMCUSTHISTORY actions', async () => {
      const arg = 42666;
