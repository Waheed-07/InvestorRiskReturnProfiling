...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ethnicity.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ETHNICITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ETHNICITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ETHNICITY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ETHNICITY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ETHNICITY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ETHNICITY actions', async () => {
      const arg = 42666;
