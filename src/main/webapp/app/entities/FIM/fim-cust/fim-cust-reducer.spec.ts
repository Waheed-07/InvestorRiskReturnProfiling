...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './fim-cust.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIMCUST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FIMCUST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FIMCUST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FIMCUST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FIMCUST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FIMCUST actions', async () => {
      const arg = 42666;
