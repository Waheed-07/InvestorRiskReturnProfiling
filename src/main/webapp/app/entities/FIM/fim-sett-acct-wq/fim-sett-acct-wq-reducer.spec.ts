...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIMSETTACCTWQ_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FIMSETTACCTWQ actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FIMSETTACCTWQ actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FIMSETTACCTWQ actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FIMSETTACCTWQ actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FIMSETTACCTWQ actions', async () => {
      const arg = 42666;
