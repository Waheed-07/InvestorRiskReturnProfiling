...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './fim-sett-acct-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIMSETTACCTHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FIMSETTACCTHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FIMSETTACCTHISTORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FIMSETTACCTHISTORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FIMSETTACCTHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FIMSETTACCTHISTORY actions', async () => {
      const arg = 42666;
