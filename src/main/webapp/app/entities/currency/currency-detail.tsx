    ...
    <Row>
      <Col md="8">
        <h2 data-cy="currencyDetailsHeading">
          <Translate contentKey="myApp.currency.detail.title">Currency</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="myApp.currency.name">Name</Translate>
            </span>
          </dt>
          <dd>{currencyEntity.name}</dd>
          <dt>
            <span id="code">
              <Translate contentKey="myApp.currency.code">Code</Translate>
            </span>
          </dt>
