...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERRESPONSES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERRESPONSES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERRESPONSES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_USERRESPONSES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_USERRESPONSES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERRESPONSES actions', async () => {
      const arg = 42666;
