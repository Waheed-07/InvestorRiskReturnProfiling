...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROFESSION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROFESSION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROFESSION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PROFESSION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PROFESSION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROFESSION actions', async () => {
      const arg = 42666;
