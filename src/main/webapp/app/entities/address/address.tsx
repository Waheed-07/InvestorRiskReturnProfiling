  ...
  return (
    <div>
      <h2 id="address-heading" data-cy="AddressHeading">
        <Translate contentKey="myApp.address.home.title">Addresses</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="myApp.address.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/address/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="myApp.address.home.createLabel">Create new Address</Translate>
          </Link>
        </div>
      </h2>
        ...
        {addressList && addressList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="myApp.address.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th className="hand" onClick={sort('city')}>
                  <Translate contentKey="myApp.address.city">City</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('city')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="myApp.address.home.notFound">No Addresses found</Translate>
            </div>
          )
        )}
      </div>
