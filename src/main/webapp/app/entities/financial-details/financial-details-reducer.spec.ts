...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './financial-details.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FINANCIALDETAILS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FINANCIALDETAILS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FINANCIALDETAILS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FINANCIALDETAILS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FINANCIALDETAILS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FINANCIALDETAILS actions', async () => {
      const arg = 42666;
